...
local default_stubs = require("tests.helpers.logcat_controls.default_stubs")
...
function M.default_stubs(vim_state, state, header_lines, panel_names, spawn_calls, clear_body_calls)
  return default_stubs.build({
    ...
    helpers = {
      buffer_set_lines = buffer_set_lines,
      set_header_lines_in_buffer = set_header_lines_in_buffer,
      trim_body_lines = trim_body_lines,
    },
  })
end
return M
